    ...
    <View style={{ marginVertical: 12 }}>
      <View style={{ flexDirection: 'row', flex: 1 }}>
        ...
        <View style={{ flex: 1, marginLeft: 12 }}>
          {/* Book Title */}
          <View>
            <Text style={{ fontSize: 22, paddingRight: 16, color: 'white' }}>{item.title}</Text>
          </View>
          {/* Meta info */}
          <View
            style={{
          ...
          >
            <MaterialCommunityIcons color="#64676D" name="book-open-page-variant" size={20} />
            ...
            />
            <Text style={{ fontSize: 14, paddingLeft: 10, color: '#64676D' }}>{item.rating}</Text>
          </View>
          {/* Buttons */}
